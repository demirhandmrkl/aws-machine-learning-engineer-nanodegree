...
def create_data_loaders(data, batch_size):
    ...
    print(f"Data directory received: {data}")
    print(f"Train data path: {train_data_path}")
    print(f"Test data path: {test_data_path}")
    print(f"Validation data path: {validation_data_path}")
    
    print(f"Train directory exists: {os.path.exists(train_data_path)}")
    print(f"Test directory exists: {os.path.exists(test_data_path)}")
    print(f"Validation directory exists: {os.path.exists(validation_data_path)}")
